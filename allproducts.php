...
<title>Example Wardrobe/Products</title>
...
<div class="Image_main_container" id="allProducts">
	<div class="index_image">
	<img class="index_image1" src="productanimation_1.jpg" >
...
if(isset($_POST['Filter_BTN']))
{
	...
	{	$Price = $_POST['Price_sort'];
		...
		}if($Price=="1500-2000")
		{
			...
			$sql="SELECT * FROM  products WHERE price>='$priceMin' AND price<='$priceMax'";
}}
...
{
	$sql="SELECT * FROM  products ORDER BY Disc DESC";
}
else
{
